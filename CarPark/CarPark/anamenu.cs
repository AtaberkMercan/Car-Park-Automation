...
namespace CarPark
{
    ...
    {
        OleDbConnection baglanti = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\Ataberk\\Documents\\otoparkveri.accdb");
        ...
        {
            chart1.Titles.Add("Yüzdeye Göre Doluluk Oranı");
            baglanti.Open();
